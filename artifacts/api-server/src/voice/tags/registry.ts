...
const definitions: TagDefinition[] = [
  ...
  { name: "pause", type: "pacing", aliases: [], description: "brief silence", strategy: "pause", parameters: { seconds: 0.35 }, spoken: false, separateAudioEvent: false, postProcess: true },
  { name: "short pause", type: "pacing", aliases: [], description: "short silence", strategy: "pause", parameters: { seconds: 0.65 }, spoken: false, separateAudioEvent: false, postProcess: true },
  { name: "long pause", type: "pacing", aliases: [], description: "long silence", strategy: "pause", parameters: { seconds: 1.25 }, spoken: false, separateAudioEvent: false, postProcess: true },
  { name: "slowly", type: "pacing", aliases: [], description: "slower speaking rate", strategy: "time_stretch", parameters: { speed: 0.78 }, spoken: false, separateAudioEvent: false, postProcess: true },
  { name: "fast", type: "pacing", aliases: [], description: "faster speaking rate", strategy: "time_stretch", parameters: { speed: 1.22 }, spoken: false, separateAudioEvent: false, postProcess: true },
  { name: "emphasis", type: "emphasis", aliases: [], description: "emphasized next speech segment", strategy: "worker_control", parameters: { energy: 1.18 }, spoken: false, separateAudioEvent: false, postProcess: false },
  ...[
